...
// Mock attendance data for Oumar
const oumarAttendance = [
...
// Mock attendance data for Aïssatou
const aissatouAttendance = [
  { id: '1', date: '14/02/2025', day: 'Vendredi', status: 'present', subject: 'Mathématiques', hours: 1.5 },
  { id: '2', date: '13/02/2025', day: 'Jeudi', status: 'present', subject: 'Français', hours: 1.5 },
  { id: '3', date: '12/02/2025', day: 'Mercredi', status: 'present', subject: 'Anglais', hours: 1 },
  { id: '4', date: '11/02/2025', day: 'Mardi', status: 'present', subject: 'Histoire', hours: 1.5 },
  { id: '5', date: '10/02/2025', day: 'Lundi', status: 'present', subject: 'Mathématiques', hours: 1.5 },
  { id: '6', date: '07/02/2025', day: 'Vendredi', status: 'present', subject: 'SVT', hours: 1.5 },
  { id: '7', date: '06/02/2025', day: 'Jeudi', status: 'late', subject: 'Français', hours: 1.5, delayMinutes: 10 },
  { id: '8', date: '05/02/2025', day: 'Mercredi', status: 'present', subject: 'Physique', hours: 1.5 },
  { id: '9', date: '04/02/2025', day: 'Mardi', status: 'present', subject: 'Anglais', hours: 1 },
  { id: '10', date: '03/02/2025', day: 'Lundi', status: 'absent', subject: 'Mathématiques', hours: 1.5, justification: 'Grippe' },
  { id: '11', date: '31/01/2025', day: 'Vendredi', status: 'present', subject: 'Histoire', hours: 1.5 },
  { id: '12', date: '30/01/2025', day: 'Jeudi', status: 'present', subject: 'Géographie', hours: 1.5 },
  { id: '13', date: '29/01/2025', day: 'Mercredi', status: 'present', subject: 'Mathématiques', hours: 1.5 },
  { id: '14', date: '28/01/2025', day: 'Mardi', status: 'present', subject: 'SVT', hours: 1.5 },
  { id: '15', date: '27/01/2025', day: 'Lundi', status: 'present', subject: 'Français', hours: 1.5 },
];

const months = ['Tous les mois', 'Février 2025', 'Janvier 2025', 'Décembre 2024'];
...
const getAttendanceData = (childId: string) => {
  return childId === '1' ? oumarAttendance : aissatouAttendance;
};
...
export default function ParentAttendance() {
  ...
  const attendanceData = getAttendanceData(selectedChild);
  ...
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-xl font-bold tracking-tight">Présence</h1>
        <p className="text-sm text-muted-foreground">
          Historique de présence de vos enfants
        </p>
      </div>
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          ...
          <p className="text-sm text-muted-foreground">
            {attendanceData.length} jours enregistrés
          </p>
        </div>
